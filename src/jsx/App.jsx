...
class App extends Component {
  ...
  drawVaccinesChart(data, svg, i) {
    ...
    .selectAll('stop')
      .data([{offset: '0%', color: 'rgba(255, 0, 0, 0.25)'},{offset: '30%', color: 'rgba(255, 0, 0, 0.40)'},{offset: '45%', color: 'rgba(255, 0, 0, 0.55)'},{offset: '55%', color: 'rgba(255, 0, 0, 0.70)'},{offset: '60%', color: 'rgba(255, 0, 0, 0.85)'},{offset: '100%', color: 'rgba(255, 0, 0, 1.0)'}]).enter()
      .append('stop')
        .attr('offset', d => d.offset)
        .attr('stop-color', d => d.color);
